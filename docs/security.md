...
Config and runtime state paths, including the module state file, are rejected
when they are symlinks, because the config file is sourced by the shell and
state files control module cleanup.
